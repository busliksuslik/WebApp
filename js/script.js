window.addEventListener('DOMContentLoaded', function(){
    ...
    next.addEventListener('click', () => {
        ...
        dots.forEach(dot.slide.opacity = ".5");
    ...
    function calcTotal(){
        ...
        if (sex === 'female'){
            result.textContent = Math.round((447.6 + (9.2 * weight) + (3.1 * height) -(4.3 * age)) * ratio * 4.18);
        } else {
            result.textContent = Math.round((88.36 + (13.4 * weight) + (4.8 * height) -(5.7 * age)) * ratio * 4.18);
        }
    }
